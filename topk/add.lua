...
local function splitShard(metaKey, targetKey, shardLimit)
        ...
        -- split. TODO 合并
        -- TODO. 极端情况，一个shard全是score相等的member, 不再split(split也没有意义)
        ...
        maxScore = getMaximiumScore(splitKey)
...
AddMember(metaKey,  4722, "1", shardLimit)
AddMember(metaKey,  15554, "2", shardLimit)
AddMember(metaKey,  10608, "3", shardLimit)
AddMember(metaKey,  59060, "4", shardLimit)
AddMember(metaKey,  28200, "5", shardLimit)
AddMember(metaKey,  49876, "6", shardLimit)
AddMember(metaKey,  37034, "7", shardLimit)
AddMember(metaKey,  53534, "8", shardLimit)
AddMember(metaKey,  33305, "9", shardLimit)
AddMember(metaKey,  42971, "10", shardLimit)
AddMember(metaKey,  14091, "11", shardLimit)
AddMember(metaKey,  36088, "12", shardLimit)
AddMember(metaKey,  62257, "13", shardLimit)
AddMember(metaKey,  26473, "14", shardLimit)
AddMember(metaKey,  28965, "15", shardLimit)
--[[
local ans = ""
for i = 0, 10000, 1 do
